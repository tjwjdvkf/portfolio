              ...
              <table class="table table-condensed">
                <tr>
                 ...
                 <c:forEach items="${list}" var="boardVO">
		     		<tr>
		     			<td>${boardVO.bno}</td>
		     			<td style="max-width: 100px; overflow: hidden; white-space: nowrap; text-overflow: ellipsis;"><a href='/boardread.do?bno=${boardVO.bno}'>${boardVO.title}</a></td>
		     			<td style="max-width: 50px; overflow: hidden; white-space: nowrap; text-overflow: ellipsis;">${boardVO.writer}</td>
		     			<td><fmt:formatDate pattern="yyyy-MM-dd HH:mm" value="${boardVO.regdate}"/></td>
		     			<td><span class="badge bg-red" style="background-color: red">${boardVO.viewcnt}</span></td>
		     		</tr>
		     	</c:forEach> 
              </table>
