            ...
            <div class="container hero">
                <div class="row">
                    <div class="col-lg-5 col-lg-offset-1 col-md-6 col-md-offset-0">
                        ...
                        <button class="btn btn-default btn-lg action-button" type="button">Learn More</button></div>
                </div>
            </div>
		      <div class="container">
		        <div class="row row-fitur" >
		            <div class="col-md-4 col-sm-4 waves-effect kolom-a">
		                ...
		                <div>
		                    ...
		                    <p class="paragraf-fitur" style="color: #cccccc">- ㅇㅇ법 최근 동향 , ㅇㅇ인증서의 관리 필요성</p>
		                </div>
		            </div>
